...
if __name__ == '__main__':
    ...
    from flashtorch_copy.saliency import Backprop
    import flashtorch

    import paddle

    x = paddle.to_tensor([2, 3, 4], 'float64')
    y = paddle.to_tensor(2, 'float64')
    z = x.add(y)
    print(z)  # [3., 8., 6. ]
    z = x.multiply(y)
    print(z)
    ...
    # #        [2., 4., 6., 8.])
    #
    # print("w.grad:", w.grad.numpy()) # w.grad: [1. 2. 3. 4.]
    # print("x.grad:", x.grad.numpy()) # x.grad: [ 4.  8. 12. 16.]
    # print("y.grad:", y.grad.numpy()) # y.grad: [2. 4. 6. 8.]
    #
    # # remove hook
    # h.remove()
